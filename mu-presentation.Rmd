...
```{r leafmap, echo=FALSE, out.height=200, out.width=500}
avgloc <- left_join(avg_weather, locations, by = "description")
leaflet(locations) %>% addTiles() %>%
  addMarkers(~longitude, ~latitude, popup = paste("Location:", avgloc$description, "<br>",
...
```{r monthly,echo=FALSE, fig.height=8, fig.width=15, fig.align='center'}
