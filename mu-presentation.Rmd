---
title: "ETC5523 CWD Presentation - mu"
subtitle: "Microclimate Patterns across Melbourne"
author:
  - Rahul Bharadwaj Mysore Venkatesh^[rmys0001@student.monash.edu]
  - Varsha Ujjinni Vijay Kumar^[vujj0001@student.monash.edu]
...
avg_weather <- weather %>% group_by(description) %>% summarise(avg = mean(summary))
...
# Average Temperature Comparision

```{r avg,echo=FALSE,fig.height=3,fig.align='center'}
...
- From the bar plot, the maximum average temperature is `r max(avg_weather$avg)` at Between 87 and 89 Grattan Street, Carlton.

- And the minimum average temperature calculated is `r min(avg_weather$avg)` at 3/121 Grattan Street, Carlton.
