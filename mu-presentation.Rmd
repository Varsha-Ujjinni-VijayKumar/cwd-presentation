...
ggplot(weather, aes(
  ...
  theme(axis.text.x = element_text(angle = 90),panel.background = element_rect(fill = "pink",
                                colour = "pink",
...
```{r daily-point,fig.height=4, fig.width=10, fig.align='center',echo=FALSE}
grouped_date <- selected_date %>% 
